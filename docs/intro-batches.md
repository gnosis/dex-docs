...
1.  Give the DeFi space in Ethereum a chance to establish the same price of a token pair in the same block 
...
<img src="assets/Batch_Auctions_Overview.png">
